//
//  OLDOwnerWorkplaceRegisterView.swift
//  MOUP
//
...
final class OLDOwnerWorkplaceRegisterView: UIView {
...
private extension OLDOwnerWorkplaceRegisterView {
...
extension Reactive where Base: OLDOwnerWorkplaceRegisterView {
